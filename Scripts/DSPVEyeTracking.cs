...
#region EyeData Setup
        private void SystemCheck()
        {
            ...
            {
                EyeTrackingAvailable = false;
                Debug.LogError("Eye Tracking Not Supported");
                return;
            }
...
#region Debug Gaze Rendering
        ...
        private static GameObject leftVisual, rightVisual;
        private static LineRenderer leftGazeLine, rightGazeLine;
        ...
        private void SetDebugGazeRender(bool status)
        {
            ...
            if (status && (leftVisual == null || rightVisual == null))
            {
                mainCam = Camera.main;
                ...
                {
                    leftGazeLine.startColor = Color.blue;
        ...
        {
            Vector3 leftOrigin, rightOrigin, leftDir, rightDir;
